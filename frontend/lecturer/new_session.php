...
<head>
  ...
  <title>New Session - Lecture Confusion Tracker</title>
...
<div class="add-confusion-wrap" style="max-width:520px;">
  ...
  <?php if ($success): ?>
    <div class="toast-success">Session created! Share the link below with your students.</div>
  <?php endif; ?>
  ...
  <form method="POST" action="new_session.php" id="session-form" novalidate>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-input" id="sess-title" name="title"
        placeholder="e.g. Week 7 - Recursion & Sorting" />
    </div>
  ...
  <?php
  // Handle POST - show a shareable link (sessions table is optional for MVP)
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      ...
      if ($courseId && $title) {
          ...
          echo '<div class="panel" style="margin-top:24px;padding:20px;">
            <div class="panel-title" style="margin-bottom:8px;">Session Created</div>
